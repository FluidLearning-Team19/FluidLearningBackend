...
import com.uiktp.finki.ukim.fluidlearning.Models.dto.*;
...
public class UsersRestController {
    ...
    public ResponseEntity<Users> login(@RequestBody LoginRequestDto loginRequestDto){
        Users user = usersService.findByUsernameandPassword(loginRequestDto.getUsername(),loginRequestDto.getPassword());
        if (user == null)
